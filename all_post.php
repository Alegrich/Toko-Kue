...
?></span>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="all_post.php">Post</a></li>
        ...
        <section class="section dashboard">
            <div class="row container">
            		<div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-left: 180px;">
									<a class="btn mt-4 col-1 text-light" style="background-color: #783F20;" href="add_post.php" role="button">Add +</a>
								</div>
            				<table class="container mt-4 ms-3">
																			<tr class="row text-center fs-5 shadow py-2 mb-2 rounded-5" style="background-color: #523838; width: 1500px;">
																				<th class="col-2 text-light fs-4">Title</th>
																				<th class="col-1 text-light fs-4">Author</th>
																				<th class="col-3 text-light fs-4">Categories</th>
																				<th class="col-2 text-light fs-4">Media</th>
																				<th class="col-2 text-light fs-4">Date</th>
																		...
																		<?php
																			...
																			$query = "select * from post LIMIT $mulaiData, $jumlahDataPerhalaman";
																			$hasil = mysqli_query($koneksi, $query);
																		...
																		<tr class="row text-center py-2 d-flex align-items-center jutisy-content-center mt-1 rounded-5" style="background-color: whitesmoke;">
																				...
																				<td class="col-1 fs-5 text-dark"><?= $data['author']?></td>
																				<td class="col-3 fs-5 text-dark"><?= $data['categories']?></td>		
																				<td class="col-2 fs-5 text-dark">
																							<img src="./assets/<?= $data['media']?>" style="width: 100px;">
																				</td>		
																				<td class="col-2 fs-5 text-dark"><?= $data['date']?></td>	
																				<td class="col-2 fs-5 text-dark">
																							<a href="edit_post.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm col-2 fs-4" style="background-color:#523838;"><i class="bi bi-pencil-square text-light"></i></a>
																							<form class="d-inline" action="delete_post_process.php" method="POST">
