                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="login.php">
                                <i class="bi bi-box-arrow-ri$username = $_SESSION['username'];
																					
			$query = "select * from admin where username = '$username'";
			$hasil = mysqli_query($koneksi, $query);
																					
			$data = mysqli_fetch_assoc($hasil);ght"></i>
                                <span>Log Out</span>
                            </a>
                        </li>
    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <section class="section dashboard mt-5">
            <div class="row container">
            				<form method="post" action="add_about_section3_process.php" class="col-lg-8">
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    <input class="form form-control fs-4"  type="text" placeholder="Add Title Here" name="title" >
                                    <div class="mt-3">
                                     <div id="container">
        ...
        <table class="container mt-4 ms-3">
																			<tr class="row text-center fs-5 shadow py-2 mb-2 rounded-5" style="background-color: #523838; width: 1500px;">
																				<th class="col-3 text-light fs-4">Title</th>
																		...
																		<tr class="row text-center py-2 d-flex align-items-center jutisy-content-center mt-1 rounded-5" style="background-color: whitesmoke;">
																				<td class="col-3 fs-5 text-dark"><?= $data['title']?></td>		
																				<td class="col-4 fs-5 text-dark"><?= $data['description']?></td>		
																				<td class="col-4 fs-5 text-dark">
																							<a href="edit_about_section3.php?id=<?= $data['id']?>" class="btn btn-succes btn-sm col-2 fs-4" style="background-color:#523838;"><i class="bi bi-pencil-square text-light"></i></a>
																							<form class="d-inline" action="delete_about_section3_process.php" method="POST">
