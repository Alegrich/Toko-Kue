    ...
    <main id="main" class="main"  style="width: 1400px;">
        ...
        <section class="section dashboard mt-5">
        		<?php
								...
								$data = mysqli_fetch_assoc($hasil);{
        		?>
								<form method="post" action="edit_blog_section2_process.php" class="col-lg-8">
            				
            				<input type="hidden" value="<?= $data['id'] ?>" name="id" />
            				
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    <input class="form form-control fs-4"  type="text" placeholder="Add Title Here" name="theme" value="<?= $data['theme']?>" >
                                    <input class="form form-control fs-4 mt-3"  type="text" placeholder="Add Name Here" name="name" value="<?= $data['name']?>" >
                                    <input class="form form-control fs-4 mt-3"  type="text" placeholder="Add Description Here" name="description" value="<?= $data['description']?>" >
                                    	...
                                    	<div class="d-flex mb-4">
																						<a href="edit_about_image_section2.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm fs-4 ms-3 mt-2" style="background-color:#523838; width:50px;"><i class="bi bi-pencil-square text-light"></i></a>
																						<input type="hidden" value="<?= $data['id']?>" name="id">
            ...
            <div class="row container">
            				<?php
												...
												$data = mysqli_fetch_assoc($hasil);{
            				?>
            				<form method="post" action="edit_about_section3_process.php" class="col-lg-8">
            				
            						<input type="hidden" value="<?= $data['id'] ?>" name="id" />
            				
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    <input class="form form-control fs-4" style="width: 700px;" type="text" placeholder="Add Title Here" name="title" value="<?= $data['title']?>">
                                    <div class="mt-3">
                                     <div id="container">
																				<input class="form form-control fs-4 mt-3"  type="text" placeholder="Add Description Here" name="description" value="<?= $data['description']?>" >
																		</div>
        ...
        <section class="section dashboard" style="padding-top: 100px;">
												 <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="card mt-5 ms-3">
                                <div class="card-body ms-3" style="width: 2300px; height: auto;">
																		<form action="media_process.php" method="post">
																						<div class="">
																							<h5 class="card-title">Media</h5>
                                    					<div class="input-group" style="width: 400px;" >
																								<input type="file" class="form-control" id="inputGroupFile02" name="foto">
																								<button class="input-group-text" for="inputGroupFile02" type="submit">Upload</button>
																							</div>
																						</div>
																		</form>
																		<hr class="dropdown-divider">
																		<div class="photo mb-4" style="width: 80rem;">
																							<?php
																								include "connect1.php";
