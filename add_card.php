    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <section class="section dashboard mt-5">
            <div class="row container">
            				<form method="post" action="add_card_process.php" class="col-lg-8">
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    ...
                                    <input type="file" class="form-control mt-3" name="news">
                                </div>
						</div><!-- End add -->
										...
										<table class="container mt-4 ms-3">
																		...
																		<tr class="row text-center d-flex align-items-center justify-content-center mt-1 rounded-3" style="background-color: whitesmoke;">
																				...
																				<td class="col-4 text-dark">
																							<a href="edit_card.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm col-2 fs-4" style="background-color:#523838;"><i class="bi bi-pencil-square text-light"></i></a>
																							<form class="d-inline" action="delete_card_process.php" method="POST">
