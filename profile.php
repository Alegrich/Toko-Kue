                                ...
                                <div class="card-body" style="width: 1000px;">
                                    ...
                                    <h5 class="card-title">Profile</h5>
																		...
																		<form method="post" action="edit_profile.php">
																					...
																					<input type="hidden" placeholder="Username" name="usernameold"  value="<?php
print_r($data['username']);
?>" required />	
																					<input type="hidden" placeholder="password" name="passwordold"  value="<?php
print_r($data['password']);
?>" required />	
																					
																						<img class="rounded-circle ms-4" alt="avatar2" src="./assets/<?php print_r($data['profile']); ?>"  style="width: 400px; height: 400px;"/>															
																						<h3 class="mt-5">Username</h3>
																						<input class="form form-control fs-4 mt-2" style="width: 500px;" type="text" placeholder="Username" name="username"  value="<?php
print_r($data['username']);
?>" required />	
																						<div class="mt-5">
																						<h3 class="mt-5">password</h3>
																						<input class="form form-control fs-4 mt-2" style="width: 500px;" type="password" id="myInput" placeholder="Username" name="password"  value="<?php
print_r($data['password']);
?>" required />													
																						...
																						<input class="form form-control fs-4 mt-2" style="width: 500px;" type="file" placeholder="Username" name="profile"  value="<?php
