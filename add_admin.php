            ...
            <div class="row container ms-auto">
           						<div class="login">
																		<div class="bg-light rounded-4 d-flex" style="width: 1500px; height: auto; background-color: white; border-radius: 15px;">
																				<form  action="add_admin_process.php" method="post"  class="container ms-5 mt-5">
																				...
																				<button class= "btn btn w-100 mt-5 mb-5" href="dashboard.php" style="background-color: #523838; color: #FFF0E4; ">Register</button>
