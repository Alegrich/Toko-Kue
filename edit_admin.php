    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row container ms-auto">
           						<div class="">
															<div class="bg-light rounded-4 d-flex" style="width: 1500px; height: auto; background-color: white; border-radius: 15px;">
																		<form method="POST" action="edit_admin_process.php" class="container ms-5">
																		
																		<input type="hidden" value="<?= $data['id'] ?>" name="id" />
																			
																						<div class="mt-5 ">
																									<label class="">Name</label>
																									<input type="text" class="form-control w-100" name="name" value="<?= $data['username'] ?>" required/>
																						</div>
																						<div class="mt-5 ">
																									<label class="">Email</label>
																									<input type="email" class="form-control w-100" name="email" value="<?= $data['email']?>" required/>
																						</div>
																						<div class="mt-5 ">
																									<label class="">Password</label>
																									<input type="password" class="form-control w-100" name="password" id="myInput" value="<?= $data['password']?>" required/>
																						...
																						<label>Profile</label>
																										<img src="./assets/<?= $data['profile']?>" style="width: 150px; margin-left: 10px; margin-top: 10px;">
																										<div class="d-flex">
																													<a href="edit_profile_admin.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm fs-4 ms-3 mt-2" style="background-color:#523838; width:50px;"><i class="bi bi-pencil-square text-light"></i></a>
																													<input type="hidden" value="<?= $data['id']?>" name="id">
