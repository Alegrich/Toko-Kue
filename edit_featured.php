...
<head>
    <title>Edit Featured Post</title>
    <!-- Favicons -->
    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <section class="section dashboard mt-5">
            <div class="row container">
            				<form method="post" action="edit_featured_process.php" class="col-lg-8">
                             ...
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    ...
                                    <input type="file" class="form-control mt-3" name="image" value="<?= $data['foto'] ?>">
                                </div>
						</div><!-- End add -->
