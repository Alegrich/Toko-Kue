    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Section1,2</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
       ...
       <section class="section dashboard mt-5" style="padding-top: 100px;">
															<div class="row container">
																			<form method="post" action="edit_section1,2_process.php" class="col-lg-8">
																			
																					<input type="hidden" value="<?= $data['id'] ?>" name="id" />
																																									
																		           <div class="d-flex justify-content-between align-items-start w-100 ms-3">
																		              <div class="w-100">
																		                  <input class="form form-control fs-4" style="width: 600px;" type="text" placeholder="Add Title Here" name="name" value="<?= $data['name'] ?>">
																		                  <img src="./assets/<?= $data['photo']?>" name="foto" style="width: 150px; margin-left: 10px; margin-top: 50px;">
																		                  	<div class="d-flex mb-4">
																															<a href="edit_image_section1,2.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm fs-4 ms-3 mt-2" style="background-color:#523838; width:50px;"><i class="bi bi-pencil-square text-light"></i></a>
																															<input type="hidden" value="<?= $data['id']?>" name="id">
																															<button class="btn btn-danger btn-sm fs-4 ms-3 mt-2" style="width: 50px;"><i class="bi bi-trash3-fill"></i></button>										
																												</div>
																		                  <div class="mt-3">
																		                   <div id="container">
																															<input class="form form-control fs-4"  type="number" placeholder="Add price Here" name="price" value="<?= $data['price'] ?>">
																											</div>
																		              </div>
															</div><!-- End add -->
