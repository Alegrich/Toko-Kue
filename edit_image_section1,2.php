...
<?php
			...
			$query = "select * from home2 where id = $id";
...
<body class="d-flex justify-content-start align-items-center" style="background-color: #FFF0E4;">
    ...
    <main id="main" class="main" style="width: 1500px;">
       ...
       <section class="section dashboard" style="padding-top: 10px;">
															<div class="row container">
																			<form method="POST" action="edit_image_section1,2_process.php" class="container ms-5">
																		
																			<input type="hidden" value="<?= $data['id'] ?>" name="id" />
																			
																						<div class="mt-5 ">
																									<label class="">Image</label>
																									<input type="file" class="form-control w-100 mt-3" name="photo" value="<?= $data['photo'] ?>" required/>
																						</div>
																						<div class="mt-5">
