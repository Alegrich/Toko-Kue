        ...
        <section class="section dashboard">
									<div class="row container">
													<div class="container mt-4 ms-3">
																			<div class="row fs-5 shadow mb-2 rounded-5" style="background-color: #523838; width: 500px; height: auto;">
																						<form method="post" action="settings_process.php" class="col-lg-8">
																							
																										<input type="hidden" value="<?= $data['id']?>" name="id" />


																										  <div class="justify-content-center align-items-center mb-5 w-100">
																										      		<div class="w-100 mt-5 ms-5">
																														      <label for="" class="text-light fs-3">Logo</label>
																														      <input type="file" class="form-control mt-3" name="logo">
																										          </div>
																										          <div class="w-100 mt-5 ms-5">
																														      <label for="" class="text-light fs-3">Link</label>
																														      <input type="text" class="form-control mt-3" placeholder="Instagram link here" name="instagram" value="<?= $data['instagram'] ?>">
																														      <input type="text" class="form-control mt-3" placeholder="Facebook link here" name="facebook" value="<?= $data['facebook'] ?>">
																														      <input type="text" class="form-control mt-3" placeholder="Twitter link here" name="twitter" value="<?= $data['twitter'] ?>">
																														      <input type="text" class="form-control mt-3" placeholder="Linkedin link here" name="linkedin" value="<?= $data['linkedin'] ?>">
																										          </div>
																										         <div class="mt-5 ms-5">
																																		<button type="submit" class="btn" style="background-color: #fff0e4;"><i class="bi bi-save me-3"></i>Save</div>
																															</div>
																										  </div>
																						</form>				      
																			</div>											
