    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <section class="section dashboard mt-5">
            <div class="row container">
            				<form method="post" action="edit_about_section2_process.php" class="col-lg-8">
            				
            					<input type="hidden" value="<?= $data['id'] ?>" name="id" />
            				
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                		<input class="form form-control fs-4"  type="text" placeholder="Theme" name="theme" value="<?= $data['theme']?>">
                                    <input class="form form-control fs-4 mt-2"  type="text" placeholder="Add Name Here" name="name" value="<?= $data['name']?>">
                                    <input type="file" class="form-control mt-3" name="foto" value="<?= $data['foto']?>" >
                                    <div class="mt-3">
                                     <div id="container">
																					<textarea id="desc" name="description" value="<?= $data['description']?>" ></textarea>
																		</div>
                                </div>
						</div><!-- End add -->
