            ...
            <div class="row container ms-auto">
           						<div class="">
															<div class="bg-light rounded-4 d-flex" style="width: 1500px; height: 25vh; background-color: white; border-radius: 15px;">
																		<form method="POST" action="edit_image_section2_process.php" class="container ms-5">
																		
																		<input type="hidden" value="<?= $data['id'] ?>" name="id" />
																			
																						<div class="mt-5 ">
																									<label class="">Image</label>
																									<input type="file" class="form-control w-100 mt-3" name="foto" value="<?= $data['cakefoto'] ?>" required/>
																						</div>
																						<div class="mt-5">
