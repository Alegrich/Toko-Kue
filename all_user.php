    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end" style="margin-left: 180px;">
							<a class="btn mt-4 col-1 text-light" style="background-color: #783F20;" href="add_user.php" role="button">Add +</a>
						</div>
            				<table class="container mt-4 ms-3">
																		...
																		<?php
																					...
																					$name = "SELECT * FROM user LIMIT $mulaiData, $jumlahDataPerhalaman"; 
																		...
																		<tr class="row text-center py-2 d-flex align-items-center jutisy-content-center mt-1 rounded-5" style="background-color: whitesmoke;">
																				...
																				<td class="col-2 text-dark">
																							<a href="edit_user.php?id=<?= $row['id'] ?>" class="btn btn-succes btn-sm col-2 fs-4" style="background-color:#523838;"><i class="bi bi-pencil-square text-light"></i></a>
																							<form class="d-inline" action="delete_user_process.php" method="POST">
