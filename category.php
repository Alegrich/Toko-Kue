   ...
   <aside id="sidebar" class="sidebar">
    ...
    <main id="main" class="main">
        ...
        <section class="section dashboard">
            <div class="row">
									<form method="post" action="add_new_category_process.php">
													<div class="col mt-4">
																	<h5>Add New Category</h5>
																	<div class="mt-5">
																					<label class="">Name</label>
																					<input type="text" class="form-control w-100" name="name" required/>
																					<h6>*name of your category</h6>
																	</div>
																		<div class="mt-5">
																					<label class="">Parent</label>
																					<select class="form-select" aria-label="Default select example">
																						<option selected>None</option>
																						<option value="one">Cake</option>
																						<option value="one">Tragedy</option>
																					</select>
																	</div>
																	<div class="mt-5">
													...
													<div class="mt-3">
																	<button type="submit" class="btn btn-success"><i class="bi bi-save me-3"></i>Save</div>
													</div>
									</form>
            </div>
            <div class="row">
            		<table class="container mt-4 ms-3">
																		<tr class="row text-center fs-5 shadow py-2 mb-2 rounded-5" style="background-color: #523838; width: 1500px;">
																				...
																				<th class="col-4 text-light fs-4">Description</th>
																				<th class="col-5 text-light fs-4">Action</th>
																		</tr>						
																			<?php
																					include "connect1.php";
																					...
																					$name = "SELECT * FROM category LIMIT $mulaiData, $jumlahDataPerhalaman"; 
																					...
																					foreach($data as $row) {
																					?>
																		<tr class="row text-center py-2 d-flex align-items-center justify-content-center mt-1 rounded-5" style="background-color: whitesmoke;">
																				<td class="col-3 text-dark"><?= $row['name']?></td>		
																				<td class="col-4 text-dark"><?= $row['description']?></td>		
																				<td class="col-5 text-dark">
																							<a href="edit_category.php?id=<?= $row['id'] ?>" class="btn btn-succes btn-sm col-2 fs-4" style="background-color:#523838;"><i class="bi bi-pencil-square text-light"></i></a>
																							<form class="d-inline" action="delete_category_process.php" method="POST">
            ...
            <ul class="pagination mt-5">
												<?php
													$totalData = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM category"));
