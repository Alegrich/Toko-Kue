    ...
    <main id="main" class="main" style="width: 1500px;">
        ...
        <section class="section dashboard mt-5">
            <div class="row container">
            				<form method="post" action="edit_post_process.php" class="col-lg-8">
                             ...
                             <div class="d-flex justify-content-between align-items-start w-100 ms-3">
                                <div class="w-100">
                                    ...
                                    <img src="./assets/<?= $data['media']?>" name="foto" style="width: 150px; margin-left: 10px; margin-top: 50px;">
                                    	<div class="d-flex mb-4">
																						<a href="edit_post_image.php?id=<?= $data['id'] ?>" class="btn btn-succes btn-sm fs-4 ms-3 mt-2" style="background-color:#523838; width:50px;"><i class="bi bi-pencil-square text-light"></i></a>
																						<input type="hidden" value="<?= $data['id']?>" name="id">
																						<button class="btn btn-danger btn-sm fs-4 ms-3 mt-2" style="width: 50px;"><i class="bi bi-trash3-fill"></i></button>										
																			</div>
                                    <div class="mt-3">
                                     <div id="container">
																					 <input class="form form-control fs-4 mt-3"  type="text"  style="width: 600px;" placeholder="Add Description Here" name="description" value="<?= $data['description']?>" >
																		</div>
                                </div>
						</div><!-- End add -->
                                        ...
                                        <div class="form-group row">
                                            <label for="">Author</label>
                                                <div class="input-group flex-nowrap">
																									<input type="text" class="form-control" placeholder="Author name" value="<?php print_r($_SESSION['username']); ?>" aria-label="Username" aria-describedby="addon-wrapping" name="author" required>
																								</div>
                                        </div>
                                    </div>
                                    <div class="form-validation mt-3">
                                        <div class="form-group row">
                                            <label for="">Category</label>
                                                <select class="form-control mt-2 ms-2" id="val-skill" name="category"  value="<?= $data['categories']?>">
                                                		<?php
																											include "connect1.php";
